...
# from qifparse.parser import QifParser  # Temporarily commented out
    ...
    def action_statement_import(self):
        ...
        if split_tup[1] == '.csv' or split_tup[1] == '.xlsx' or split_tup[
            ...
            if split_tup[1] == '.csv':
                ...
                # QIF file parsing temporarily disabled due to missing qifparse dependency
                raise ValidationError(_("QIF file format is not supported in this installation. Please contact administrator."))
        else:
            raise ValidationError(_("Choose correct file"))
