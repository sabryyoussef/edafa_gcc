...
class OpenItemsReportWizard(models.TransientModel):
    ...
    def on_change_account_range(self):
        if (
            ...
            # String bounds only: Odoo 19 code search is str-based; int caused RPC TypeError.
            start_range = self.account_code_from.code or ""
            end_range = self.account_code_to.code or ""
            # Range is lexical (string order), not numeric; mixed-length codes are unchanged.
