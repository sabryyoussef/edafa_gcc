...

{
    ...
    'category': 'Hidden',
    'version': '1.0',
    # html_builder: provides @mixin o-apply-colors (builder.variables.scss) required
    # by website/portal SCSS in web.assets_frontend. Without this dependency, asset
    # merge order can compile ica/website SCSS before the mixin exists (Odoo 19).
    'depends': ['web', 'base_setup', 'html_builder'],
    'auto_install': False,
    'data': [
    ...
    'assets': {
        ...
        'web.assets_frontend': [
            ('prepend', 'ica_web_responsive/static/src/scss/frontend_compat.scss'),
